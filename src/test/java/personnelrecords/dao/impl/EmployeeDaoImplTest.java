...
public class EmployeeDaoImplTest {
    ...
    public void createEmployee() throws SQLException {
        ...
        employee.setEntryDate((long) (2010 - 02 - 01));
    ...
    public void findAll() {
        ...
        employee_ONE.setEntryDate(LocalDate.of(2010, 2, 1).toEpochDay());
        ...
        employee_ONE.setBirthDay(LocalDate.of(2000, 6, 4).toEpochDay());
        ...
        employee_TWO.setEntryDate(LocalDate.of(2005, 11, 5).toEpochDay());
        ...
        employee_TWO.setBirthDay(LocalDate.of(1997, 04, 12).toEpochDay());
    ...
    public void update() {
            ...
            employeeWithNewDate.setEntryDate((long) (2010 - 02 - 01));
            ...
            employeeWithNewDate.setBirthDay((long) (2000 - 06 - 04));
