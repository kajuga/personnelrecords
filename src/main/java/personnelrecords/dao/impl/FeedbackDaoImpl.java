...
public class FeedbackDaoImpl implements FeedbackDAO {
    ...
    public Feedback create(Feedback feedback) {
        ...
        try {
            ...
            PreparedStatement prepStat = connection.prepareStatement("INSERT INTO personnelrecords.feedback (description) VALUES (?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public boolean remove(Long id) {
        ...
        try {
            connection = connectionPool.getConnection();
            PreparedStatement prepStat = connection.prepareStatement("DELETE FROM personnelrecords.feedback WHERE id = (?)");
    ...
    public void update(Long id, Feedback feedback) {
        ...
        try {
            connection = connectionPool.getConnection();
            PreparedStatement prepStat = connection.prepareStatement("UPDATE personnelrecords.feedback SET description = (?) WHERE id = (?)");
            prepStat.setString(1, feedback.getDescription());
    ...
    public Feedback findById(Long id) {
        ...
        try {
            connection = connectionPool.getConnection();
            PreparedStatement prepStat = connection.prepareStatement("SELECT * FROM personnelrecords.feedback WHERE id = ?");
            prepStat.setLong(1, id);
    ...
    public List<Feedback> findAll() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM personnelrecords.feedback");
            while (resultSet.next()) {
                Feedback feedback = new Feedback();
                feedback.setId(resultSet.getLong(1));
                feedback.setDescription(resultSet.getString("description"));
