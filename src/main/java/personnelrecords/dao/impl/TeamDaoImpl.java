...
public class TeamDaoImpl implements TeamDAO {
    ...
    public Team create(Team team) {
        ...
        try {
            ...
            PreparedStatement prepStat = connection
                    .prepareStatement("INSERT INTO personnelrecords.team (title) VALUES (?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public boolean remove(Long id) {
        ...
        try {
            connection = connectionPool.getConnection();
            PreparedStatement prepStat = connection
                    .prepareStatement("DELETE FROM personnelrecords.team WHERE id = (?)");
    ...
    public void update(Long id, Team team) {
        ...
        try {
            connection = connectionPool.getConnection();
            PreparedStatement prepStat = connection
                    .prepareStatement("UPDATE personnelrecords.team SET title = (?) WHERE id = (?)");
            prepStat.setString(1, team.getTitle());
    ...
    public Team findById(Long id) {
        ...
        try {
            connection = connectionPool.getConnection();
            PreparedStatement prepStat = connection
                    .prepareStatement("SELECT * FROM personnelrecords.team WHERE id = (?)");
            prepStat.setLong(1, id);
