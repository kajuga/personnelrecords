...
import personnelrecords.dao.interfaces.TeamDAO;
...
public class ProjectDaoImpl implements ProjectDAO {
    ...
    public Project create(Project project) {
        ...
        try {
            ...
            PreparedStatement prepStat = connection.prepareStatement(
                     "INSERT INTO personnelrecords.project (name, client, duration, methodology, project_manager, team_id) VALUES (?,?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public boolean remove(Long id) {
        ...
        try {
            connection = connectionPool.getConnection();
             PreparedStatement prepStat = connection.prepareStatement("DELETE FROM personnelrecords.project WHERE id = (?)");
    ...
    public void update(Long id, Project project) {
        ...
        try {
            connection = connectionPool.getConnection();
            PreparedStatement prepStat = connection.prepareStatement("UPDATE personnelrecords.project SET name = (?), " +
        ...
        try {
            connection = connectionPool.getConnection();
             PreparedStatement prepStat = connection
                     .prepareStatement("SELECT * FROM personnelrecords.project WHERE id = (?)");
            prepStat.setLong(1, id);
